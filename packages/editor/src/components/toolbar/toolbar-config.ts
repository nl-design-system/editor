...
export const defaultToolbarConfig: ToolbarConfig = [
  ...
  [TOOLBAR_ITEM.BOLD, TOOLBAR_ITEM.ITALIC, TOOLBAR_ITEM.UNDERLINE, TOOLBAR_ITEM.STRIKE],
  [TOOLBAR_ITEM.CODE, TOOLBAR_ITEM.HIGHLIGHT, TOOLBAR_ITEM.SUPERSCRIPT, TOOLBAR_ITEM.SUBSCRIPT],
  ...
  [TOOLBAR_ITEM.KEYBOARD_SHORTCUTS],
];
