  ...
  describe('Tables', () => {
    it('parses table html correctly it returns', async () => {
      ...
      expect(editor.getHTML()).toEqual(
        `<h1>Title</h1><table class="utrecht-table"><caption>caption</caption><thead><tr><th colspan="1" rowspan="1"><p>tablehead</p></th><th colspan="1" rowspan="1"><p>tablehead</p></th></tr></thead><tbody headrows="0" rowheadcolumns="0"><tr><td colspan="1" rowspan="1"><p>table body cell</p></td><td colspan="1" rowspan="1"><p>table body cell</p></td></tr></tbody></table>`,
      );
    });
