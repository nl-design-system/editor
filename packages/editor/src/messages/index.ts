...
export type ValidationKey = ElementValidationKey | InlineValidationKey | DocumentValidationKey;
...
export const validationMessages = (): ValidationMessages =>
  ({
    ...
    [elementValidations.DEFINITION_DESCRIPTION_MUST_FOLLOW_TERM]: {
      description: msg('Definition description must follow a definition term'),
    },
    [elementValidations.DESCRIPTION_LIST_MUST_CONTAIN_TERM]: {
      description: msg('Definition list must contain a definition term'),
    },
    [elementValidations.HEADING_MUST_NOT_BE_EMPTY]: {
    ...
    [elementValidations.HEADING_SHOULD_NOT_CONTAIN_BOLD_OR_ITALIC]: {
    ...
    [elementValidations.PARAGRAPH_MUST_USE_SEMANTIC_LIST]: {
    ...
    [elementValidations.PARAGRAPH_SHOULD_NOT_RESEMBLE_HEADING]: {
    ...
    [elementValidations.TABLE_MUST_HAVE_HEADINGS]: {
      description: msg('Table must contain headings'),
    },
    [elementValidations.TABLE_MUST_HAVE_MULTIPLE_ROWS]: {
    ...
    [inlineValidations.MARK_SHOULD_NOT_BE_EMPTY]: {
    ...
    [inlineValidations.MARK_SHOULD_NOT_BE_UNDERLINED]: {
