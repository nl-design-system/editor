...
describe('Validator', () => {
  ...
  it('lets a page validation read the nearest earlier match across fragments, in the order they are given', () => {
  ...
  it('judges content without its page against a proxy content fragment holding the outline above it', () => {
    const validator = new Validator({ validations: Object.values(coreValidations) });
