...
import { headingMustNotBeAboveTopLevel } from './must-not-be-above-top-level/index.ts';
...
export const headingValidations = {
  ...
  [headingValidationRules.HEADING_MUST_NOT_BE_ABOVE_TOP_LEVEL]: headingMustNotBeAboveTopLevel,
